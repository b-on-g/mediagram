...
;
	...
	($mol_mem(($.$bog_mediagram_app_chip.prototype), "click"));
	($.$bog_mediagram_app_card) = class $bog_mediagram_app_card extends ($.$mol_view) {
		Kind_flag(){
			const obj = new this.$.$mol_view();
...
(function ($) {
    ...
    (function ($$) {
        ...
        const KIND_ORDER = ['all', 'movie', 'series', 'book', 'game', 'anime'];
