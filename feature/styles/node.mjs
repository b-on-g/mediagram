...
(function ($) {
    ...
    (function ($$) {
        ...
        class $bog_mediagram_app extends $.$bog_mediagram_app {
            ...
            top_content() {
                const items = [this.Brand(), this.Search(), this.Theme_toggle()];
                if (this.in_extension())
                    items.push(this.Add_btn());
                return items;
            }
            add_click(e) {
                if (e)
            ...
            add_from_snapshot() {
                ...
                if (snap.entity.kind)
                    media.Kind('auto').val(snap.entity.kind);
                if (snap.entity.year) {
                    try {
                        media.Year('auto').val(BigInt(snap.entity.year));
                    }
